...
Main.prototype = {
	...
	,setValues: function() {
		console.log("setValues (from settings)");
	...
	,setCanvas: function() {
		console.log("setCanvas " + Main.count);
		Main.count++;
...
art_CC051a.prototype = $extend(SketchBase.prototype,{
	...
	,draw100HabbitPattern: function() {
		...
		var _this14 = _this13;
		_this14._textBaseline = "middle";
		var _this15 = _this14;
		var x1 = this.scaling(50);
		var y1 = this.scaling(120);
		_this15._x = x1;
		_this15._y = y1;
		var _this16 = _this15;
...
cc_model_constants_Paper.inMM = function(papersize) {
	...
	case "A6":
		...
		break;
	default:
		console.log("case '" + papersize + "': trace ('" + papersize + "');");
	}
...
model_constants_App.BUILD = "2019-03-09 10:09:51";
Main.main();
